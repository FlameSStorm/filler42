...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/06 11:17:48 by dkotlyar          #+#    #+#             */
/*   Updated: 2018/07/06 12:32:24 by dkotlyar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				save_piece(char *tmp, t_meta *meta, int fd)
{
	...
	RET_CHECK(meta->piece.piece =
			(char**)malloc(sizeof(char*) * (meta->piece.size_x + 1)));
	i = 0;
